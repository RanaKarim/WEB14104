...
<h3 class="startertitle"> Noodles in Soup </h3>
...
if( have_rows('noodles_in_soup_1') ):

  // loop through the rows of data
    while ( have_rows('noodles_in_soup_1') ) : the_row();
...
// check if the repeater field has rows of data
if( have_rows('noodles_in_soup_2') ):

  // loop through the rows of data
    while ( have_rows('noodles_in_soup_2') ) : the_row();
...
<table class="tablemenu">
  ...
  <tr>
    <th><?php the_field('food_group_3');?></th>
  </tr>
...
// check if the repeater field has rows of data
if( have_rows('noodles_in_soup_3') ):

  // loop through the rows of data
    while ( have_rows('noodles_in_soup_3') ) : the_row();
    ...
    ?>  
     ...
     <tr>
        ...
        <td class="chilli" ><?php the_sub_field('hot_sign');?></td>
        <td class="veggie"><?php the_sub_field('vegetarien_sign');?></td>
        <td ><?php the_sub_field('variation_1');?></td>
        <td class="important"><?php the_sub_field('price_1');?></td>
        <td ><?php the_sub_field('variation_2');?></td>
        <td class="important"><?php the_sub_field('price_2');?></td>
        <td ><?php the_sub_field('variation_3');?></td>
        <td class="important"><?php the_sub_field('price_3');?></td>
        <td><input class="numberinput"  type="number" name="quantity" min="0" max="99" value="0"></td>
        <td><button>Add</button></td>        
     </tr>    
