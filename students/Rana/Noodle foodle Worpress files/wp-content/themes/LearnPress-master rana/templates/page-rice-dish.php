...
<h3 class="startertitle"> Rice Dishes </h3>
...
<table class="tablemenu">
  <tr>
    <th><?php the_field('food_group_1');?></th>
  </tr>
...
if( have_rows('rice_dish_1') ):

  // loop through the rows of data
    while ( have_rows('rice_dish_1') ) : the_row();
...
// check if the repeater field has rows of data
if( have_rows('rice_dish_2') ):

  // loop through the rows of data
    while ( have_rows('rice_dish_2') ) : the_row();
